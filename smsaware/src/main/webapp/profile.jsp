               ...
               <ul class="nav">
                  <li>
                     <a class="dashboard-link"
                        href="javascript:showonlyone('dashboardId');">
                        <i
                           class="pe-7s-graph"></i>
                        <p>Dashboard</p>
                     </a>
                  ...
                  <li>
                     <a class="user-link"
                        href="javascript:showonlyone('userProfileId');">
                        <i
                           class="pe-7s-user"></i>
                        <p>User Profile</p>
                     </a>
                  ...
                  <li>
                     <a class="contect-link"
                        href="javascript:showonlyone('contactListId');">
                        <i
                           class="pe-7s-note2"></i>
                        <p>Contacts List</p>
                     </a>
                  ...
                  <li>
                     <a class="notifications-link"
                        href="javascript:showonlyone('notificationId');">
                        <i
                           class="pe-7s-bell"></i>
                        <p>Notifications</p>
                     </a>
                              ...
                              <div class="regiSearch1">
                                 <table>
                                    <tr>
                                       ...
                                       <th><input class="message_submit br2up" value="Locate"
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        <div class="card card-plain">
                           <div class="header">
                              <button type="submit" id="NewContactId" class="btn btn-info btn-fill">Add New Contact
                                 </button>
                                 <div class="clearfix"></div>
                           </div>
