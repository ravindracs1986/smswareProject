				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="link-effect-2" id="link-effect-2">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="clients.jsp"><span data-hover="Clients">Clients</span></a></li>
	...
	<div class="typo">
		<div class="container">
           ...
           <div class="agile_about_grids">
				...
				<p class="quia">Client's Words</p>
					
					<p>Business to consumer (B2C) is business or transactions conducted directly between a company and consumers who are the end-users of its products or services.
The business-to-consumer as a business model differs significantly from the business-to-business model, which refers to commerce between two or more businesses. While most companies that sell directly to consumers can be referred to as B2C companies
, the term became immensely popular during the dotcom boom of the late 1990s, when it was used mainly to refer to online retailers, as well as other companies that sold products and services to consumers through the internet
<br>
<p class="quia">Type Of B2C</p>

Intermediaries perform a brokerage function. In these cases the B2C business fulfills the role of a middleman between consumers who visit its site and businesses whom it represents.
These approaches are identical to traditional marketing but are specifically adapted to the Web. The high-traffic approach emphasizes sheer numbers and thus offers products of wide interest at median price-point. 
Those using the niche approach are willing to pay substantially for a pre-qualified audience with specific income and/or interest profiles
<br>
<p class="quia">The Future</p>
The future of B2C appears to be bright. This type of commerce may still only be in its infancy and likely to grow simply because it is a convenient form of purchasing and also because looming storm clouds on the energy horizon may soon cause a quick trip to the store cost consumers a tidy sum.
 Leaves in the wind, suggesting the trend, are provided by the recent history of electronic retailing, more than half of all B2C
</p>
